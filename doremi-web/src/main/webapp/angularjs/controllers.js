...
// Get the message id from the route (parsed from the URL) and use it to // find
// the right message object.
function DetailController($scope, $routeParams) {
	$scope.message = messages[$routeParams.id];
}

aMailServices.controller('ListController', ListController);
aMailServices.controller('DetailController', DetailController);
...
function emailRouteConfig($routeProvider) {
	...
	// by placing a colon in front of the id 40 |
	when('/view/:id', {
